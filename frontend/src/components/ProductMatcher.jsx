...
//         setIsLoading(true);
//         setError(null);
//         // We no longer clear results here, allowing the old results to stay during a new search
//         // setResults([]); 
...
//             const API_ENDPOINT = `http://localhost:8000/search/?min_similarity=${minSimilarityFloat}`;
...
//         } finally {
//             setIsLoading(false);
//             // --- CHANGE #1: REMOVED the lines that clear the preview ---
//             // setImagePreview(null);
//             // setSelectedFile(null);
//             // setImageUrl('');
//         }
...
//     // --- CHANGE #2: ENHANCED the remove function to be a full reset ---
//     const removePreview = () => {
//         setImagePreview(null);
//         setSelectedFile(null);
//         setImageUrl('');
//         setResults([]); // Also clear the results
...
//                                     <button onClick={removePreview} className="remove-btn">×</button>
//                                 </div>
//                             ) : (
//                                 <>
...
//             {/* The search button is now always visible when an image is selected */}
